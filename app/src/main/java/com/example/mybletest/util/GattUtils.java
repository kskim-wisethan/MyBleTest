...
import static com.example.mybletest.util.Constants.CHARACTERISTIC_ECHO_STRING;
import static com.example.mybletest.util.Constants.CHARACTERISTIC_TIME_STRING;
import static com.example.mybletest.util.Constants.CLIENT_CONFIGURATION_DESCRIPTOR_SHORT_ID;
import static com.example.mybletest.util.Constants.SERVICE_STRING;
...
public class GattUtils {
    ...
    public static List<BluetoothGattCharacteristic> findCharacteristics(BluetoothGatt bluetoothGatt) {
        ...
        BluetoothGattService service = GattUtils.findService(serviceList);
        if (service == null) {
